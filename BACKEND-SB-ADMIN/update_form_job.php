                ...
                <div class="container-fluid">
                    ...
                    <form action="action_update_job.php" method="post">
                        <div class="mb-3">
                            ...
                            name="nama_pekerjaan" value="<?php echo
                            $job->nama_pekerjaan ?>">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            name="tahun_bekerja" value="<?php echo
                            $job->tahun_bekerja ?>">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            name="tempat_bekerja" value="<?php echo
                            $job->tempat_bekerja ?>">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            $job->deskripsi ?></textarea>

                        </div>
                        <input type="hidden" value="<?php echo $job->id_job?>"
                        name="id_job">
