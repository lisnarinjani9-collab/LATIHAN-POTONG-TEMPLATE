            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <table class="table table-striped"> 
                        ...
                        <tbody>
                            <?php
                while ($tampil = mysqli_fetch_object($select_mobile)):
                        ?>
                    <tr>
                        ...
                        <td>
                                <a href="delete_mobile.php?id_mobile=<?php
                                echo $tampil->id_mobile;?>" class="btn
                                btn-danger" onclick="return confirm
                                ('confirm to delete?')">DELETE</a>
                                <a href="update_form_mobile.php?id_mobile=<?php
                                echo $tampil->id_mobile;?>" class="btn
