...
$select_id = mysqli_query($koneksi, "SELECT*FROM education WHERE
                ...
                <div class="container-fluid">
                    ...
                    <form action="action_update_education.php" method="post">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="jurusan" name="nama_jurusan" value="<?php echo
                                $education->nama_jurusan ?>">
                        </div>

                        <div class="mb-3">
                            <label for="belajar" class="form-label"> Year</label>
                            <input type="text" class="form-control" id="belajar" name="tahun_belajar" value="<?php echo
                                $education->tahun_belajar ?>">
                        </div>

                        <div class="mb-3">
                            <label for="tempat" class="form-label"> Place</label>
                            <input type="text" class="form-control" id="tempat" name="tempat_belajar" value="<?php echo
                                $education->tempat_belajar ?>">
                        </div>

                        <div class="mb-3">
                            <label for="deskripsi" class="form-label"> Description</label>
                            <textarea name="deskripsi" id="deskripsi" cols="30" class="form-control" rows="10"><?php echo
